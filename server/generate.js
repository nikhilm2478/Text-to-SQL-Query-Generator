import openaiClient from "/Users/nikhilmukherjee/Desktop/OPENAI-API-SQL/server/api.js";

const generate = async (queryDescription) => {
    const daVinci= async (queryDescription) => {
        const response = await openaiClient.createCompletion({
            model: "text-davinci-003",
            prompt: `Convert the following natural language description to an SQL query:\n\n${queryDescription}.`,
            max_tokens: 100,
            temperature: 0
        });
